//tyrosine hydroxylase (TH) analysis for entorhinal cortext (EC) subregion
...
/// segmenting TH. still needs some work. can be adjusted for better background subtraction.
