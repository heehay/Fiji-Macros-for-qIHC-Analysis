...
**Additional adjustable watershed plugin is necessary to run the macros.
    Adjustable watershed plugin from:
        ...
        [media/adjustable-watershed/Adjustable_Watershed.java ](https://github.com/imagej/imagej.github.io/blob/main/media/adjustable-watershed/Adjustable_Watershed.java) OR
